...
(function() {
	var methods = Object.getOwnPropertyNames(litecoin.Client.prototype).filter(function(p) {
	    return typeof litecoin.Client.prototype[p] === 'function' && p !== "cmd" && p!= "constructor";
	})
...
module.exports.Client = litecoin.Client;
